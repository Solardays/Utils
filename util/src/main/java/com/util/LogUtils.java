...
public final class LogUtils {
    ...
    private static String  sGlobalTag         = defaultTag();  // The global tag of log.
    ...
    public static void e(final String msg,Throwable tr) {
        eTag(sGlobalTag, msg, tr);
    }

    public static void eTag(final String tag,final String msg,Throwable tr) {
