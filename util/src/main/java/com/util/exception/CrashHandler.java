...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void init(Context context) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
            ...
            defaultDir = mContext.getExternalCacheDir() + FILE_SEP + CRASH_FLOD_NAME;
        else {
            defaultDir = mContext.getCacheDir() + FILE_SEP + CRASH_FLOD_NAME ;
        }
        if(null==crashDir || "".equals(crashDir.trim())){
            crashDir = defaultDir;
        }else{
     ...
     * @param context
     */
    public void init(Context context,String crashDir,OnCrashListener onCrashListener) {
...
//        uploadFile();
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            if (pi != null) {
                infos.put("Device Manufacturer", Build.MANUFACTURER);
                infos.put("Device Model", Build.MODEL);
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            crashFile = crashDir+ FILE_SEP + fileName;
