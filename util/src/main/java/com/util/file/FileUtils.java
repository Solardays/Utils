...
public final class FileUtils {
     ...
     */
    public static boolean isAvailableSpace(File file,int sizeMb){
        boolean isHasSpace = false;
        if (!file.exists()) {
            return isHasSpace;
        }
        long freeSpace = file.getFreeSpace();
        long availableSpare = freeSpace / MemoryConstants.MB;
        LogUtils.d("path: %s availableSpare = %s MB sizeMb: %s", file.getAbsolutePath(), availableSpare, sizeMb);
