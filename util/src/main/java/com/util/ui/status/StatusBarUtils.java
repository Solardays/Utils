...
public final class StatusBarUtils {
    ...
    @StatusBarConstants.Unit
    private static int statusBarType = StatusBarConstants.DEFAULT;
    ...
    public static void setColor(Fragment fragment, Window window, int color, int statusBarAlpha) {
        ...
        BarUtils.setStatusBarColor(fragment.getActivity(),color,statusBarAlpha);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            // 生成一个状态栏大小的矩形
            View statusView = createStatusBarView(fragment.getActivity(), color, statusBarAlpha);
            // 添加 statusView 到布局中
    ...
    public static void setColor(Activity activity, @ColorInt int color, @IntRange(from = 0,
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    public static void setColorForSwipeBack(Activity activity, @ColorInt int color, @IntRange(from = 0,
            to = 255) int statusBarAlpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {

            ViewGroup contentView = activity.findViewById(android.R.id.content);
            final View rootView = contentView.getChildAt(0);
            ...
            if (rootView != null && rootView instanceof CoordinatorLayout) {
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    ((CoordinatorLayout)rootView).setStatusBarBackgroundColor(
            ...
            setTransparentForWindow(activity.getWindow());
        }
    }
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    public static void setTranslucent(Activity activity, @IntRange(from = 0,
            to = 255) int statusBarAlpha) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
    ...
    public static void setTranslucent(Fragment fragment, Window window, @IntRange(from = 0,
            to = 255) int statusBarAlpha) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        setTransparent(fragment, window);
        addTranslucentView(window.getContext(), window, statusBarAlpha);
    }
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    public static void setTranslucentForCoordinatorLayout(Activity activity, @IntRange(
            from = 0, to = 255) int statusBarAlpha) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        transparentStatusBar(activity);
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTransparentForImageView(Window window, View needOffsetView) {
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTranslucentForImageView(Window window, View needOffsetView) {
    ...
    public static void setTranslucentForImageView(
        ...
        if (needOffsetView != null) {
            if (needOffsetView.getTag(TAG_KEY_HAVE_SET_OFFSET) != null) {
                return;
            }
    ...
    public static void setTranslucentForImageView(
        ...
        if (needOffsetView != null) {
            ...
            ViewGroup.MarginLayoutParams layoutParams = (ViewGroup.MarginLayoutParams) needOffsetView.getLayoutParams();
            layoutParams.setMargins(layoutParams.leftMargin,
                    layoutParams.topMargin + getStatusBarHeight(window.getContext()),
                    layoutParams.rightMargin, layoutParams.bottomMargin);
            needOffsetView.setTag(TAG_KEY_HAVE_SET_OFFSET, true);
        }
    }
    ...
    private static void clearPreviousSetting(Activity activity) {
        ...
        if (fakeStatusBarView != null) {
            ...
            View rootView = ((ViewGroup)(activity.findViewById(android.R.id.content))).getChildAt(
                    0);
     ...
     */
    private static void addTranslucentView(Activity activity, @IntRange(from = 0,
            to = 255) int statusBarAlpha) {
        ViewGroup contentView = activity.findViewById(android.R.id.content);
     ...
     * @param statusBarAlpha 透明值
     */
    private static void addTranslucentView(Context context, Window window, @IntRange(from = 0,
            to = 255)int statusBarAlpha) {
     ...
     * 设置透明
     */
    private static void setTransparentForWindow(Window window) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
     ...
     * @return 半透明 View
     */
    private static View createTranslucentStatusBarView(Context context, int alpha){
        // 绘制一个和状态栏一样高的矩形
        View statusBarView = new View(context);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                getStatusBarHeight(context));
